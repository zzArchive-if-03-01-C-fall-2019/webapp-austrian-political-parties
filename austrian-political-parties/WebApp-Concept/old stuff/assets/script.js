...
function alertFunc() {
  canvas.player1.heatlh -= player1.regen;
  canvas.player2.heatlh -= player2.regen;
}
...
for (var i = 0; i <= maxFrames; ++i) {
    ...
    player1Sprites[i].src = "assets/RendiWagnerRight().png";
    if (i == maxFrames) {
        anim1 = function(){
...
for (var j = 0; j <= maxFrames; ++j) {
    ...
    player2Sprites[j].src = "assets/SebastianKurzLeft().png";
    if (j == maxFrames) {
        anim2 = function(){
